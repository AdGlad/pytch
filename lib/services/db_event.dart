...
class DbEventService {
  ...
  Future<void> updateEventoffer(
    ...
    return await eventCollection
      ..doc(uid)
          .update({
            'offer': {'type': offertype, 'sdp': offersdp}
          })
  ...
  Future<void> updateEventconnection(
    ...
    return await eventCollection
      ..doc(uid)
          ...
          .catchError(
              (error) => print("Failed to update Connected property: $error"));
  }
  ...
  Future<void> updateEventcandidate(
    ...
    return await
        ...
        eventCollection
          ..doc(uid)
              .update({
                'candidate': {'type': candidatetype, 'sdp': candidatesdp}
              })
              .then((value) => print("candidate Property updated"))
              .catchError(
                  (error) => print("Failed to update candidate: $error"));
  }
